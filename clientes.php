            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="cli-nombre" class="form-control" placeholder="Ej: Juan Pérez">
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header" style="background: var(--verde-oscuro); color: #fff;">
                    <h5 class="modal-title">📊 Estadísticas de <span id="est-cli-nombre"></span></h5>
                ...
                <div class="modal-body">
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <div class="card stat-card shadow-sm border-0 h-100">
                                <div class="card-body d-flex align-items-center gap-3">
                                    <div class="stat-icon stat-icon-compras">📄</div>
                                    <div>
                        ...
                        <div class="col-md-4">
                            <div class="card stat-card shadow-sm border-0 h-100">
                                <div class="card-body d-flex align-items-center gap-3">
                                    <div class="stat-icon stat-icon-gastado">💰</div>
                                    <div>
                        ...
                        <div class="col-md-4">
                            <div class="card stat-card shadow-sm border-0 h-100">
                                <div class="card-body d-flex align-items-center gap-3">
                                    <div class="stat-icon stat-icon-promedio">📊</div>
                                    <div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6 text-end">
                            <small class="text-muted">Última compra: <strong id="est-ultima-compra">-</strong></small>
                        </div>
                    </div>
