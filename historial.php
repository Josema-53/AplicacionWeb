            ...
            <div class="container-fluid px-4">
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        <div class="card stat-card border-0 shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="stat-icon stat-icon-total me-3">💰</div>
                                <div>
                    ...
                    <div class="col-md-4">
                        <div class="card stat-card border-0 shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="stat-icon stat-icon-cantidad me-3">📄</div>
                                <div>
                    ...
                    <div class="col-md-4">
                        <div class="card stat-card border-0 shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="stat-icon stat-icon-promedio me-3">📊</div>
                                <div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-3">
                                <label class="form-label fw-semibold small">Cliente (nombre o cédula)</label>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <h6 class="fw-bold" style="color: var(--verde-medio);">Información General</h6>
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-1"><strong>Cédula:</strong> <span id="detalle-cedula"></span></p>
                            <p class="mb-1"><strong>Teléfono:</strong> <span id="detalle-telefono"></span></p>
